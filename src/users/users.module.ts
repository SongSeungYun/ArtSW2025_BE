...
@Module({
  ...
  providers: [UsersService, UserRepository, LocalAuthRepository, SocialAuthRepository, RefreshTokenRepository],
  exports: [UsersService, UserRepository, LocalAuthRepository, SocialAuthRepository, RefreshTokenRepository], // 다른 모듈에서 사용 가능
})
